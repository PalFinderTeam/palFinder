...
class LocationTest {
    ...
    fun distancePretty() {
        ...
        Mockito.`when`(cont.getString(eq(R.string.pretty_location_m), any(String::class.java)))
            .thenReturn("In M")
        Mockito.`when`(cont.getString(eq(R.string.pretty_location_km), any(String::class.java)))
            .thenReturn("In Km")
