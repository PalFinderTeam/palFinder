package com.github.palFinderTeam.palfinder.login
...
/**
 * LoginActivity where a user can connect his account or create one
 */
@AndroidEntryPoint
class LoginActivity : PalFinderBaseActivity() {
    ...
    private suspend fun updateUI(user: FirebaseUser?) {
        ...
        if (firebaseProfileService.exists(user.uid)) {
            ...
            val intent = Intent(this, UserProfileSettingsActivity::class.java).apply {
