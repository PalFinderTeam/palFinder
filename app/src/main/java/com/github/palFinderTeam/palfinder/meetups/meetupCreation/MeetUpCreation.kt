...
class MeetUpCreation : Fragment(R.layout.activity_meet_up_creation_new), IconDialog.Callback {
    ...
    private fun forwardBind() {
        ...
        criteriaSelectButton.setOnClickListener {
            CriterionFragment(viewModel).show(childFragmentManager, getString(R.string.criteria))
        }
    }
    ...
    /**
     * user cannot edit the capacityField if the meetup has no max capacity
    ...
    private fun selectLocation() {
        val action =
            MeetUpCreationDirections.actionCreationPickLocation()
